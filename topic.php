...
<head>
    ...
    <title>Buurtstem - Topic <?php echo $topic["id"]; ?></title>
        ...
        <div class="card">
            ...
            <div class="commentSection">
                <div class="commentForm">
                    ...
                    <a href="#" class="submitComment" data-topicid="<?php echo $topic['id'] ?>"> <i class="fas fa-paper-plane" style="color: #C78743;"></i></a>
                </div>
